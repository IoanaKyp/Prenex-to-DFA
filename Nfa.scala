...
//  def makeConcatNfa(c1:Char, c2:Char):Nfa[Int] = {
//    return new Nfa(0, Set(0,1,2), Set(2), Set((0,1,c1), (1,2,c2)), Set());
//  }
//
//  def makeUnionNfa(c1:Char, c2:Char):Nfa[Int] = {
//    return new Nfa(0, Set(0,1), Set(1), Set((0,1,c1), (0,1,c2)), Set());
//  }
//
//  def makeStarNfa(c1:Char):Nfa[Int] = {
//    return new Nfa(0, Set(0,1,2,3), Set(3), Set((1,2,c1)), Set((0,3), (0,1),
//      (2,3), (2,1)));
//  }
